...
@section('content')
 ...
 <section class="section--main">
      <img src="{{asset('../src/home-firstCopy.jpg')}}" class="section__img" alt="">
  ...
  <section class="section--second">
    ...
    <div class="section__img ">
      <img src="{{asset('../src/platillo1.jpg')}}" class="section__img--top-left" alt="">
      <img src="{{asset('../src/platillo3.jpg')}}" class=" section__img--right mx-auto d-block" alt="">
      <img src="{{asset('../src/platillo2.jpg')}}" class="section__img--bott-left" alt="">
    </div>
  ...
  <section class="section--sponsor">
    ...
    <div class="section--sponsor__items text-center ">
      <img class="section__img" src="{{asset('../src/p-joseph.png')}}" alt="">
      <img class="section__img" src="{{asset('../src/p-beer.png')}}" alt="">
      <img class="section__img" src="{{asset('../src/p-jw.png')}}" alt="">
      <img class="section__img" src="{{asset('../src/p-uber.png')}}" alt="">
      <img class="section__img" src="{{asset('../src/p-gs.png')}}" alt="">
      <img class="section__img" src="{{asset('../src/p-thepearl.png')}}" alt="">
    </div>
  </section>
